  ...
  return (
    <>
      ...
      <footer className="bg-white border-t border-[#EAECEF] pt-24 pb-12 relative overflow-hidden">
        ...
        <div className="hidden md:block absolute top-0 left-1/4 w-[500px] h-[500px] bg-[#0057FF]/[0.015] rounded-full blur-[100px] pointer-events-none z-0"></div>
      ...
      {isWidgetLoaded && (
        ...
        className={`fixed bottom-24 right-4 sm:right-6 md:right-8 z-50 w-[calc(100vw-2rem)] sm:w-[330px] md:w-[360px] max-w-[360px] rounded-2xl overflow-hidden shadow-2xl transition-all duration-300 ease-out transform bg-white ${
          chatOpen 
        ...
        <div className="bg-[#075E54] text-white px-5 py-4 flex items-center justify-between shadow-md">
          <div className="flex items-center gap-3">
            <div className="relative w-10 h-10 rounded-full bg-white flex items-center justify-center overflow-hidden border border-white/20 shadow-inner">
              <Image src="/assets/images/marca/Logo.png" alt="EQUIPANEXT" width={40} height={40} className="w-full h-full object-contain p-1" />
      ...
      <div className={`flex fixed left-2 sm:left-4 xl:left-6 top-1/2 -translate-y-1/2 flex-col gap-2 sm:gap-3 transition-all duration-300 z-50 ${chatOpen ? 'max-md:opacity-0 max-md:pointer-events-none' : 'opacity-100'}`}>
        <a href="https://www.facebook.com/share/18EB6ALGgX/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-8 h-8 sm:w-[42px] sm:h-[42px] rounded-full bg-[#1B1F24] border border-[#333] text-white flex items-center justify-center hover:bg-[#1877F2] hover:border-transparent hover:scale-110 transition-all duration-300 shadow-lg group">
          <svg fill="currentColor" viewBox="0 0 24 24" width="16" height="16" className="sm:w-5 sm:h-5 group-hover:animate-pulse drop-shadow-md"><path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" /></svg>
        </a>
        <a href="https://www.instagram.com/equipanext4359?igsh=MW9kb2F5NWYyZGZ6ag==" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-8 h-8 sm:w-[42px] sm:h-[42px] rounded-full bg-[#1B1F24] border border-[#333] text-white flex items-center justify-center hover:bg-gradient-to-tr hover:from-[#f09433] hover:via-[#dc2743] hover:to-[#bc1888] hover:border-transparent hover:scale-110 transition-all duration-300 shadow-lg group">
          <svg fill="currentColor" viewBox="0 0 24 24" width="16" height="16" className="sm:w-5 sm:h-5 group-hover:animate-pulse drop-shadow-md"><path fillRule="evenodd" d="M12.315 2c2.43 0 2.784.013 3.808.06 1.064.049 1.791.218 2.427.465a4.902 4.902 0 011.772 1.153 4.902 4.902 0 011.153 1.772c.247.636.416 1.363.465 2.427.048 1.067.06 1.407.06 4.123v.08c0 2.643-.012 2.987-.06 4.043-.049 1.064-.218 1.791-.465 2.427a4.902 4.902 0 01-1.153 1.772 4.902 4.902 0 01-1.772 1.153c-.636.247-1.363.416-2.427.465-1.067.048-1.407.06-4.123.06h-.08c-2.643 0-2.987-.012-4.043-.06-1.064-.049-1.791-.218-2.427-.465a4.902 4.902 0 01-1.772-1.153 4.902 4.902 0 01-1.153-1.772c-.247-.636-.416-1.363-.465-2.427-.047-1.024-.06-1.379-.06-3.808v-.63c0-2.43.013-2.784.06-3.808.049-1.064.218-1.791.465-2.427a4.902 4.902 0 011.153-1.772A4.902 4.902 0 015.45 2.525c.636-.247 1.363-.416 2.427-.465C8.901 2.013 9.256 2 11.685 2h.63zm-.081 1.802h-.468c-2.456 0-2.784.011-3.807.058-.975.045-1.504.207-1.857.344-.467.182-.8.398-1.15.748-.35.35-.566.683-.748 1.15-.137.353-.3.882-.344 1.857-.047 1.023-.058 1.351-.058 3.807v.468c0 2.456.011 2.784.058 3.807.045.975.207 1.504.344 1.857.182.466.399.8.748 1.15.35.35.683.566 1.15.748.353.137.882.3 1.857.344 1.054.048 1.37.058 4.041.058h.08c2.597 0 2.917-.01 3.96-.058.976-.045 1.505-.207 1.858-.344.466-.182.8-.398 1.15-.748.35-.35.566-.683.748-1.15.137-.353.3-.882.344-1.857.048-1.055.058-1.37.058-4.041v-.08c0-2.597-.01-2.917-.058-3.96-.045-.976-.207-1.505-.344-1.858a3.097 3.097 0 00-.748-1.15 3.098 3.098 0 00-1.15-.748c-.353-.137-.882-.3-1.857-.344-1.023-.047-1.351-.058-3.807-.058zM12 6.865a5.135 5.135 0 110 10.27 5.135 5.135 0 010-10.27zm0 1.802a3.333 3.333 0 100 6.666 3.333 3.333 0 000-6.666zm5.338-3.205a1.2 1.2 0 110 2.4 1.2 1.2 0 010-2.4z" clipRule="evenodd" /></svg>
        </a>
        <a href="https://www.tiktok.com/@equipanext?_r=1&_t=ZS-96jDl6JgP5Q" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="w-8 h-8 sm:w-[42px] sm:h-[42px] rounded-full bg-[#1B1F24] border border-[#333] text-white flex items-center justify-center hover:bg-black hover:border-transparent hover:scale-110 transition-all duration-300 shadow-lg group">
          <svg fill="currentColor" viewBox="0 0 24 24" width="16" height="16" className="sm:w-5 sm:h-5 group-hover:animate-pulse drop-shadow-md"><path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.95v7.4c-.01 1.94-.65 3.86-1.83 5.33-1.18 1.48-2.83 2.45-4.7 2.81-1.87.35-3.84.14-5.55-.61-1.71-.74-3.11-2.02-3.97-3.64-.86-1.61-1.11-3.51-.71-5.32.4-1.81 1.43-3.41 2.92-4.52 1.49-1.12 3.33-1.63 5.18-1.43V12.1c-1.36-.15-2.75.14-3.92.83-1.17.69-2.07 1.81-2.51 3.12-.44 1.3-.35 2.74.24 3.97.59 1.23 1.63 2.18 2.91 2.66 1.28.48 2.74.41 3.97-.21 1.23-.62 2.18-1.66 2.65-2.94.47-1.28.49-2.7-.01-3.98-.36-.93-.97-1.74-1.74-2.33v-13.2h4.01z"/></svg>
        </a>
      </div>

      {/* Floating WhatsApp Trigger Button */}
      {isWidgetLoaded && (
      <div className="fixed bottom-6 right-4 sm:right-6 md:bottom-8 md:right-8 z-50 flex items-center justify-center">
