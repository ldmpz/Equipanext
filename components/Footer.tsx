  ...
  return (
    <>
      ...
      <footer className="bg-white border-t border-[#EAECEF] pt-24 pb-12 relative overflow-hidden">
        ...
        <div className="hidden md:block absolute top-0 left-1/4 w-[500px] h-[500px] bg-[#FFC107]/[0.03] rounded-full blur-[100px] pointer-events-none z-0"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-16 mb-16">
            ...
            <div className="md:col-span-12 lg:col-span-5 flex flex-col items-start">
              ...
              <div className="flex items-center gap-4">
                <a href="https://www.facebook.com/share/18EB6ALGgX/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-10 h-10 rounded-full border border-[#EAECEF] flex items-center justify-center text-[#4b5563] hover:text-[#1877F2] hover:border-[#1877F2]/30 hover:bg-[#F5F7FA] transition-all duration-300">
                ...
                <a href="https://www.instagram.com/equipanext4359?igsh=MW9kb2F5NWYyZGZ6ag==" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-10 h-10 rounded-full border border-[#EAECEF] flex items-center justify-center text-[#4b5563] hover:text-[#E1306C] hover:border-[#E1306C]/30 hover:bg-[#F5F7FA] transition-all duration-300">
                ...
                <a href="https://www.tiktok.com/@equipanext?_r=1&_t=ZS-96jDl6JgP5Q" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="w-10 h-10 rounded-full border border-[#EAECEF] flex items-center justify-center text-[#4b5563] hover:text-black hover:border-black/30 hover:bg-[#F5F7FA] transition-all duration-300">
            ...
            <div className="md:col-span-4 lg:col-span-2 flex flex-col gap-4">
              ...
              <Link href="/productos" className="text-[#4b5563] hover:text-[#FFC107] text-sm font-light transition-colors">Chalecos Reflejantes</Link>
              <Link href="/productos" className="text-[#4b5563] hover:text-[#FFC107] text-sm font-light transition-colors">Uniformes Industriales</Link>
              <Link href="/servicios" className="text-[#4b5563] hover:text-[#FFC107] text-sm font-light transition-colors">Bordado Corporativo</Link>
              <Link href="/servicios" className="text-[#4b5563] hover:text-[#FFC107] text-sm font-light transition-colors">Serigrafía Técnica</Link>
            </div>

            {/* Empresa Column */}
            <div className="md:col-span-4 lg:col-span-2 flex flex-col gap-4">
              <h4 className="text-[#1B1F24] font-semibold text-[11px] uppercase tracking-[0.15em] mb-2">Empresa</h4>
              <Link href="/nosotros" className="text-[#4b5563] hover:text-[#FFC107] text-sm font-light transition-colors">Sobre Nosotros</Link>
              <Link href="/nosotros" className="text-[#4b5563] hover:text-[#FFC107] text-sm font-light transition-colors">Infraestructura</Link>
              <Link href="/contacto" className="text-[#4b5563] hover:text-[#FFC107] text-sm font-light transition-colors">Contacto B2B</Link>
            </div>

            {/* Soporte Column */}
            <div className="md:col-span-4 lg:col-span-3 flex flex-col gap-4">
              <h4 className="text-[#1B1F24] font-semibold text-[11px] uppercase tracking-[0.15em] mb-2">Atención a Clientes</h4>
              <a href="mailto:ventasequipanext@gmail.com" className="text-[#4b5563] hover:text-[#FFC107] text-sm font-light transition-colors flex items-center gap-2">
      ...
      {isWidgetLoaded && (
        ...
        >
          {/* Widget card */}
          <div className="relative bg-[#071A33] rounded-2xl overflow-visible pt-2">
            {/* Close Button */}
            <button 
      ...
      <div className={`hidden md:flex fixed left-4 xl:left-6 top-1/2 -translate-y-1/2 flex-col gap-3 transition-all duration-300 z-50 ${chatOpen ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
        <a href="https://www.facebook.com/share/18EB6ALGgX/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-[42px] h-[42px] rounded-full bg-[#1B1F24] border border-[#333] text-white flex items-center justify-center hover:bg-[#1877F2] hover:border-transparent hover:scale-110 transition-all duration-300 shadow-lg group">
        ...
        <a href="https://www.instagram.com/equipanext4359?igsh=MW9kb2F5NWYyZGZ6ag==" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-[42px] h-[42px] rounded-full bg-[#1B1F24] border border-[#333] text-white flex items-center justify-center hover:bg-gradient-to-tr hover:from-[#f09433] hover:via-[#dc2743] hover:to-[#bc1888] hover:border-transparent hover:scale-110 transition-all duration-300 shadow-lg group">
        ...
        <a href="https://www.tiktok.com/@equipanext?_r=1&_t=ZS-96jDl6JgP5Q" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="w-[42px] h-[42px] rounded-full bg-[#1B1F24] border border-[#333] text-white flex items-center justify-center hover:bg-black hover:border-transparent hover:scale-110 transition-all duration-300 shadow-lg group">
      ...
      {isWidgetLoaded && (
        <div className="fixed bottom-6 right-4 sm:right-6 md:bottom-8 md:right-8 z-50 flex flex-col items-center gap-2">
          ...
          {!chatOpen && (
            <div className="bg-[#071A33] text-white text-[10px] font-bold tracking-widest uppercase px-3 py-1.5 rounded-full shadow-lg border border-white/10 whitespace-nowrap animate-fade-in-up">
              ¿Necesitas ayuda?
            </div>
          )}
          ...
          <div className="relative flex items-center justify-center">
            ...
            <button 
              ...
              className="relative w-[62px] h-[62px] md:w-[68px] md:h-[68px] rounded-full overflow-hidden border-[2.5px] border-[#FFC107] hover:scale-110 hover:border-white transition-all duration-300 shadow-2xl cursor-pointer bg-[#071A33] z-10"
