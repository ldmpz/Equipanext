  ...
  return (
    <main className="bg-[#04142B] text-white min-h-screen">
      ...
      <section className="relative w-full pt-[160px] pb-[100px] md:pt-[200px] md:pb-[140px] px-6 md:px-12 bg-[#061A36] overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-[#082041]/60 rounded-full blur-[80px] pointer-events-none z-0"></div>

        <div className="relative z-10 max-w-4xl mx-auto text-center fade-in-up">
          <div className="inline-flex items-center gap-2.5 bg-[#04142B]/85 backdrop-blur-md border border-[#FFC107]/30 text-[#FFC107] font-bold text-[11px] px-5 py-2 rounded-md mb-8 uppercase tracking-[0.2em]">
      ...
      <section className="py-[80px] md:py-[120px] px-6 md:px-12 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 lg:gap-8">
           {/* Contact Form */}
          <div className="md:col-span-12 lg:col-span-8 bg-[#082041] border border-[rgba(255,193,7,0.15)] rounded-2xl shadow-sm p-8 md:p-14 relative overflow-hidden">
            <div className="absolute top-0 left-0 w-1 h-full bg-[#FFC107]"></div>
            <h2 className="text-2xl font-display font-extrabold text-white mb-2 tracking-tight uppercase">Envíenos un Mensaje</h2>
            <p className="text-[#D9D9D9]/70 text-sm mb-10 font-light">Responderemos en un máximo de 24 horas hábiles.</p>
            
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="flex flex-col gap-3">
                  <label className="text-[11px] font-semibold text-[#D9D9D9]/80 uppercase tracking-[0.1em]" htmlFor="name">Nombre Completo</label>
                  <input 
                    className="w-full bg-[#04142B] border border-[rgba(255,193,7,0.15)] rounded-lg px-5 py-3.5 text-sm text-white transition-all focus:outline-none focus:ring-2 focus:ring-[#FFC107]/40 focus:border-[#FFC107] placeholder-[#D9D9D9]/40 font-light" 
                    id="name" 
                    name="name" 
                ...
                <div className="flex flex-col gap-3">
                  <label className="text-[11px] font-semibold text-[#D9D9D9]/80 uppercase tracking-[0.1em]" htmlFor="company">Empresa</label>
                  <input 
                    className="w-full bg-[#04142B] border border-[rgba(255,193,7,0.15)] rounded-lg px-5 py-3.5 text-sm text-white transition-all focus:outline-none focus:ring-2 focus:ring-[#FFC107]/40 focus:border-[#FFC107] placeholder-[#D9D9D9]/40 font-light" 
                    id="company" 
                    name="company" 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="flex flex-col gap-3">
                  <label className="text-[11px] font-semibold text-[#D9D9D9]/80 uppercase tracking-[0.1em]" htmlFor="phone">Teléfono</label>
                  <input 
                    className="w-full bg-[#04142B] border border-[rgba(255,193,7,0.15)] rounded-lg px-5 py-3.5 text-sm text-white transition-all focus:outline-none focus:ring-2 focus:ring-[#FFC107]/40 focus:border-[#FFC107] placeholder-[#D9D9D9]/40 font-light" 
                    id="phone" 
                    name="phone" 
                ...
                <div className="flex flex-col gap-3">
                  <label className="text-[11px] font-semibold text-[#D9D9D9]/80 uppercase tracking-[0.1em]" htmlFor="email">Correo Electrónico</label>
                  <input 
                    className="w-full bg-[#04142B] border border-[rgba(255,193,7,0.15)] rounded-lg px-5 py-3.5 text-sm text-white transition-all focus:outline-none focus:ring-2 focus:ring-[#FFC107]/40 focus:border-[#FFC107] placeholder-[#D9D9D9]/40 font-light" 
                    id="email" 
                    name="email" 
              ...
              <div className="flex flex-col gap-3">
                <label className="text-[11px] font-semibold text-[#D9D9D9]/80 uppercase tracking-[0.1em]" htmlFor="product">Producto o Servicio de Interés</label>
                <div className="relative">
                  <select 
                    className="w-full bg-[#04142B] border border-[rgba(255,193,7,0.15)] rounded-lg px-5 py-3.5 text-sm text-white appearance-none transition-all focus:outline-none focus:ring-2 focus:ring-[#FFC107]/40 focus:border-[#FFC107] font-light" 
                    id="product" 
                    name="product"
                  ...
                  <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-5 text-[#D9D9D9]">
              ...
              <div className="flex flex-col gap-3">
                <label className="text-[11px] font-semibold text-[#D9D9D9]/80 uppercase tracking-[0.1em]" htmlFor="message">Detalle de Solicitud</label>
                <textarea 
                  className="w-full bg-[#04142B] border border-[rgba(255,193,7,0.15)] rounded-lg px-5 py-3.5 text-sm text-white transition-all resize-none focus:outline-none focus:ring-2 focus:ring-[#FFC107]/40 focus:border-[#FFC107] placeholder-[#D9D9D9]/40 font-light" 
                  id="message" 
                  name="message" 
          ...
          <div className="md:col-span-12 lg:col-span-4 flex flex-col gap-6 lg:gap-8">
            ...
            {/* Primary Action Card */}
            <div className="bg-[#082041] border border-[rgba(255,193,7,0.15)] rounded-2xl shadow-xl p-10 flex flex-col items-start gap-6 relative overflow-hidden">
              ...
              <div className="w-14 h-14 bg-[#FFC107] rounded-xl flex items-center justify-center mb-2 relative z-10 shadow-lg">
                <span className="material-symbols-outlined text-[#04142B] text-[28px]">support_agent</span>
              </div>
              <div className="relative z-10">
                ...
                <a className="inline-flex justify-center items-center gap-2 bg-[#FFC107] hover:bg-[#FFB300] text-[#04142B] font-extrabold text-[12px] px-6 py-3.5 rounded-md transition-all duration-300 w-full tracking-widest uppercase" href="https://wa.me/525524398773?text=Hola,%20requiero%20asistencia%20inmediata" target="_blank" rel="noopener noreferrer">
            ...
            <div className="bg-[#082041] border border-[rgba(255,193,7,0.15)] p-8 rounded-2xl flex flex-col gap-6 shadow-sm">
              <div className="flex items-start gap-4">
                <div className="w-11 h-11 rounded-lg bg-[#04142B] flex items-center justify-center flex-shrink-0 shadow-md">
                ...
                <div>
                  ...
                  <p className="text-white font-semibold text-sm">Chimalhuacán, Estado de México</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a className="text-white font-semibold text-sm hover:text-[#FFC107] transition-colors" href="mailto:ventasequipanext@gmail.com">ventasequipanext@gmail.com</a>
            ...
            {/* Map */}
            <div className="h-[200px] rounded-2xl border border-[rgba(255,193,7,0.15)] overflow-hidden relative group shadow-sm">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#04142B]/90 to-transparent flex items-end p-5">
